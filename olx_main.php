...
<!--	<link rel="javascript" href="olx.js"> -->
	<link rel="stylesheet" type="text/css" href="Css/olx.css?v=1">
   ...
   <div class="nav1">
 	...
 	<div class="country_select" id="country">
 		...
 		<form method="post" class="searchbox" enctype="multipart/form-data">
 			<input type="text" class="searchclass" name="search" id="searchid" placeholder="Find Cars, Mobile Phone and more...">
 			<button name="searchaa" id="search"> <i class="fa-solid fa-magnifying-glass"></i> </button>
...
<button id="loadmoreid">Load More</button>
	...
	<div class="lmproduct" id="lmproductid">
		    <div class="first_row">
<?php
